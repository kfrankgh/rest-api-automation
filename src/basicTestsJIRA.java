...
import static resources.commonMethods.getCommentId;
import static resources.commonMethods.getIssueId;
import static resources.commonMethods.sessionId;
    ...
    public Response updateComment(String sessionId, String comment){
        ...
        Response response = given().header("Content-Type", "application/json").and()
                ...
                .body("{" +
                        ...
                        "}")
                .when()
                .put(String.format(String.format("/rest/api/2/issue/%s/comment/%s"), issueId, commentId)).then()
